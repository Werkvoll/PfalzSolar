...
class backupbuddy_live_troubleshooting {
	...
	public static function _test_godaddy_managed_wp() {
		if ( defined( 'GD_SYSTEM_PLUGIN_DIR' ) || class_exists( '\\WPaaS\\Plugin' ) ) {
			self::$_results['alerts'][] = 'GoDaddy Managed WordPress Hosting detected. This hosting may be incompatible with Stash Live, manual backups, and other backup or scheduling plugins due to their broken cron. Choose any other webhost for a better experience.';
		}
	}
