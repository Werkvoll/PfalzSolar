...
DROP TABLE IF EXISTS `rinck_icl_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rinck_icl_translations` (
...
LOCK TABLES `rinck_icl_translations` WRITE;
/*!40000 ALTER TABLE `rinck_icl_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `rinck_icl_translations` ENABLE KEYS */;
UNLOCK TABLES;
