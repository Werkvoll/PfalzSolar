...
DROP TABLE IF EXISTS `ps_dev_icl_translation_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ps_dev_icl_translation_status` (
...
LOCK TABLES `ps_dev_icl_translation_status` WRITE;
/*!40000 ALTER TABLE `ps_dev_icl_translation_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `ps_dev_icl_translation_status` ENABLE KEYS */;
UNLOCK TABLES;
