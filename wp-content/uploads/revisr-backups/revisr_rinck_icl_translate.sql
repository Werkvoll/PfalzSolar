...
DROP TABLE IF EXISTS `rinck_icl_translate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rinck_icl_translate` (
...
LOCK TABLES `rinck_icl_translate` WRITE;
/*!40000 ALTER TABLE `rinck_icl_translate` DISABLE KEYS */;
/*!40000 ALTER TABLE `rinck_icl_translate` ENABLE KEYS */;
UNLOCK TABLES;
