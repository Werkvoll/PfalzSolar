...
DROP TABLE IF EXISTS `paket_icl_translate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paket_icl_translate` (
...
LOCK TABLES `paket_icl_translate` WRITE;
/*!40000 ALTER TABLE `paket_icl_translate` DISABLE KEYS */;
/*!40000 ALTER TABLE `paket_icl_translate` ENABLE KEYS */;
UNLOCK TABLES;
