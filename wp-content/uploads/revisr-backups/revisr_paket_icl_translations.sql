...
DROP TABLE IF EXISTS `paket_icl_translations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paket_icl_translations` (
...
LOCK TABLES `paket_icl_translations` WRITE;
/*!40000 ALTER TABLE `paket_icl_translations` DISABLE KEYS */;
/*!40000 ALTER TABLE `paket_icl_translations` ENABLE KEYS */;
UNLOCK TABLES;
