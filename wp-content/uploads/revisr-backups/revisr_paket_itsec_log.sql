...
DROP TABLE IF EXISTS `paket_itsec_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `paket_itsec_log` (
...
LOCK TABLES `paket_itsec_log` WRITE;
/*!40000 ALTER TABLE `paket_itsec_log` DISABLE KEYS */;
INSERT INTO `paket_itsec_log` VALUES (1,'user_logging','User Action',1,'2016-10-10 10:46:08','2016-10-10 08:46:08','79.208.46.186','admin',1,'','','a:2:{s:6:\"action\";s:15:\"Content Updated\";s:4:\"post\";i:4;}');
/*!40000 ALTER TABLE `paket_itsec_log` ENABLE KEYS */;
UNLOCK TABLES;
